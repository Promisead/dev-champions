...
const Aboutdata: datatype[] = [
  {
    ...
    paragraph:
      "Established with a vision to redefine the landscape of IT solutions, we are a dynamic and forward-thinking company.",
    link: "Learn more",
  },
  {
    heading: "Services.",
    ...
    <div id="aboutus-section">
      <div className="mx-auto max-w-7xl px-4 py-24 my-32 lg:px-10 bg-lightgrey rounded-3xl relative">
        <Image
          ...
          unoptimized
        />
        <h3 className="text-center text-blue text-lg tracking-widest py-3">
          ABOUT US
        </h3>

        <WordPullUp
          className="text-4xl text-center lg:text-65xl  font-bold tracking-[-0.02em] text-black  md:text-7xl md:leading-[5rem]"
