...
const AnimatedBeam = () => {
  return (
    ...
    <main className="md:px-0 md:mx-auto items-center justify-center mx-auto">
      <h1 className="text-3xl ml-2 md:text-5xl font-medium flex  md:flex-row items-start md:items-center gap-x-2 mx-auto justify-start md:justify-center z-9 text-left md:text-center">
        Our{" "}
